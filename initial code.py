...
# Load dataset
url = r"C:\Users\mahmo\Desktop\Mahmoud's Studying\iris.csv"
names = ['sepal-length', 'sepal-width', 'petal-length', 'petal-width', 'class']
dataset = read_csv(url, names=names)

#Statistical peek
print(dataset.shape) # shape
print(dataset.head(20))# head (first 10 Rows and columns)
print(dataset.describe())# statistical description
